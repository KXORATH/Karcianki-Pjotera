...
var cards1 = ["hajto1.png", "hajto1.png", "hajto2.png", "hajto2.png", "hajto3.png", "hajto3.png", "hajto4.png", "hajto4.png", "hajto5.png", "hajto5.png", "hajto6.png", "hajto6.png"];
...
function restore2Cards(nr1, nr2)
{
	...
	$('#c'+nr1).css('background-image', 'url(img/karta_hajto.png)');
	
	$('#c'+nr2).removeClass("cardA");
	$('#c'+nr2).css('background-image', 'url(img/karta_hajto.png)');
