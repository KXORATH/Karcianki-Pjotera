...
var cards1 = ["sasin1.png", "sasin1.png", "sasin2.png", "sasin2.png", "sasin3.png", "sasin3.png", "sasin4.png", "sasin4.png", "sasin5.png", "sasin5.png", "sasin6.png", "sasin6.png"];
...
function restore2Cards(nr1, nr2)
{
	...
	$('#c'+nr1).css('background-image', 'url(img/karta_sasin.png)');
	
	$('#c'+nr2).removeClass("cardA");
	$('#c'+nr2).css('background-image', 'url(img/karta_sasin.png)');
