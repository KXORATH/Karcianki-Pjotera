...
var cards1 = ["stonoga1.png", "stonoga1.png", "stonoga2.png", "stonoga2.png", "stonoga3.png", "stonoga3.png", "stonoga4.png", "stonoga4.png", "stonoga5.png", "stonoga5.png", "stonoga6.png", "stonoga6.png"];
...
function restore2Cards(nr1, nr2)
{
	...
	$('#c'+nr1).css('background-image', 'url(img/karta_stonoga.png)');
	
	$('#c'+nr2).removeClass("cardA");
	$('#c'+nr2).css('background-image', 'url(img/karta_stonoga.png)');
